...
<head>
  ...
  <title>유니스오더 | 크로스보더 셀러 운영 플랫폼</title>
  <meta name="description" content="Shopee·Lazada 주문, 재고, 마진, 분석 업무를 한곳에서 관리하는 크로스보더 셀러 플랫폼입니다." />
...
<body>
  <header class="site-header">
    <div class="shell header-inner">
      <a class="logo-link" href="/" aria-label="UnisOrder 홈">
      ...
      <div class="header-actions">
        <a class="button button-ghost" href="<%= loginUrl %>">
          <span aria-hidden="true">↗</span>
          로그인
        </a>
        <a class="button button-primary header-cta" href="<%= loginUrl %>">
          무료로 시작하기
          <span aria-hidden="true">→</span>
        </a>
      </div>
      ...
      <details class="mobile-menu">
        ...
        <div class="mobile-menu-panel">
          ...
          <a class="mobile-primary" href="<%= loginUrl %>">무료로 시작하기</a>
        </div>
      </details>
    </div>
  </header>
  ...
  <main>
    <section class="hero section-top">
      <div class="shell hero-shell">
        <div class="eyebrow">
          ...
          <span class="eyebrow-text">Shopee·Lazada 2개 플랫폼 8개국 운영 통합</span>
        </div>
        <p class="hero-lead">주문은 늘어나는데,<br class="mobile-only" /> 관리 시간은 줄어들지 않으시죠?</p>
        <h1>
          주문 처리에
          <span><span class="mobile-line">운영 시간을</span> <span class="mobile-line">빼앗기지 마세요</span></span>
        </h1>
        <p class="hero-subline">복잡한 크로스보더 운영,<br class="mobile-only" /> 주문부터 재고, 마진까지<br class="mobile-only" /> 한곳에서 관리하세요.</p>

        <div class="hero-highlights" aria-label="핵심 기능">
          <div><span>▣</span><strong>2개 플랫폼 8개국 통합 대시보드</strong></div>
          <div><span>▤</span><strong>실시간 주문 처리 & 한글 송장 출력</strong></div>
          <div><span>▥</span><strong>실시간 주문 추적 & 수익 분석</strong></div>
          <div><span>✾</span><strong>스마트 재고 & 발주 관리</strong></div>
          <div><span>▧</span><strong>부가세신고자료 & 소포수령증 발급 자료<br class="mobile-only" />원클릭 제공</strong></div>
        </div>

        <div class="hero-actions">
          <a class="button button-primary button-large cta-version-one" href="<%= loginUrl %>">
            무료로 시작하기
            <span aria-hidden="true">→</span>
          </a>
          <a class="button button-secondary button-large" href="<%= guideUrl %>">이용 가이드 보기</a>
        </div>

        <p class="hero-proof"><span>✺</span><strong>해외 역직구 전문 셀러들의 실운영 노하우를 담은<br class="mobile-only" /> 크로스보더 셀러 플랫폼</strong></p>
    ...
    <section class="problem-section">
      <div class="shell">
        <h2>혹시 이런 고민으로<br />밤을 지새우고 계신가요?</h2>
        <div class="problem-grid">
          <article class="problem-card">
            <span class="problem-icon">⌁</span>
            <h3>오늘 처리할 주문 한눈에 안 보임</h3>
            <p>국가별·샵별 주문을 따로 열어보느라<br />처리 흐름이 계속 끊겨요.</p>
          </article>
          <article class="problem-card">
            <span class="problem-icon blue">文</span>
            <h3>상품명은 외국어, 실수는 내 책임</h3>
            <p>8개국 언어로 표시되는 상품명과 옵션을<br />매번 확인하며 발주·포장해야 해요.</p>
          </article>
          <article class="problem-card">
            <span class="problem-icon yellow">↻</span>
            <h3>같은 제품 오늘만 2번째 주문</h3>
            <p>통합으로 주문 확인이 안 되어 같은 제품을<br />하루에 여러 번 주문하게 됩니다.</p>
          </article>
        </div>

        <div class="solution-band">
          <div>
            <h3>단순 반복 업무는 유니스오더에 맡기고</h3>
            <p>셀러님은 제품 소싱과 마케팅에 더 집중하세요.</p>
          </div>
          <div class="metric-row">
            <div><strong>72%</strong><span>발주시간 감소</span></div>
            <div><strong>48%</strong><span>재고 운영비용 절감</span></div>
          </div>
          <a class="button button-primary button-large cta-version-one" href="<%= loginUrl %>">지금 바로 고민 해결하러 가기 <span>→</span></a>
        </div>
      </div>
    </section>
    ...
    <section id="features" class="feature-section">
      <div class="shell">
        <h2 class="gradient-title">글로벌 셀러들을 위한 올인원 솔루션</h2>

        <div class="feature-tabs" role="tablist" aria-label="기능 보기">
        ...
        <div class="feature-panel">
          ...
          <div class="feature-image-stage" aria-live="polite">
          ...
          <div class="story-track">
            <article class="story-card">
              <div class="seller-profile">
                ...
                <span class="seller-accent emerald"></span>
                <div>
                  <p>6개국 12개샵 운영 셀러</p>
                  <strong>M 셀러님</strong>
                </div>
              </div>
              <blockquote>“샵이 늘어나면서 주문 확인보다<br />정리에 더 많은 시간이 들기 시작했어요.”</blockquote>
              <h3>국가별 주문과 재고를 한곳에서 확인해 발주·포장 흐름을 단순화했습니다</h3>
              <div class="before-after">
                <div><span>Before</span><p>샵별로 주문을 따로 확인하고 재고를 수기로 맞추느라 반복 정리에 많은 시간이 쓰였습니다.</p></div>
                <div><span>After</span><p>통합 화면에서 주문과 재고를 함께 확인하면서 상품 확장과 판매 전략에 더 집중할 수 있었습니다.</p></div>
              </div>
            </article>
            ...
            <article class="story-card">
              <div class="seller-profile">
                <span class="seller-avatar">🧑‍💼</span>
                <span class="seller-accent sky"></span>
                <div>
                  <p>4년차 장기 운영 셀러</p>
                  <strong>J 셀러님</strong>
                </div>
              </div>
              <blockquote>“사무실에 있지 않아도<br />주문 흐름을 놓치지 않는 게 가장 컸어요.”</blockquote>
              <h3>외부에서도 발주 타이밍을 놓치지 않고 주문 흐름을 유지했습니다</h3>
              <div class="before-after">
                <div><span>Before</span><p>자리를 비우거나 여행 중일 때 발주 타이밍을 놓칠까 봐 개인 일정을 쉽게 잡기 어려웠습니다.</p></div>
                <div><span>After</span><p>외부에서도 주문 확인과 발주가 가능해져 장소에 얽매이지 않는 운영 구조를 만들 수 있었습니다.</p></div>
              </div>
            </article>

            <article class="story-card">
              <div class="seller-profile">
                <span class="seller-avatar">🙋‍♀️</span>
                <span class="seller-accent violet"></span>
                <div>
                  <p>6개월차 투잡 셀러</p>
                  <strong>R 셀러님</strong>
                </div>
              </div>
              <blockquote>“주문이 늘어나는 건 좋은데,<br />혼자 감당할 수 있을지가 제일 걱정이었어요.”</blockquote>
              <h3>한글 송장과 발주 시스템으로 주문이 늘어도 혼자 운영할 수 있었습니다</h3>
              <div class="before-after">
                <div><span>Before</span><p>외국어 상품명 확인과 송장 준비에 퇴근 후 시간이 빠르게 사라져 혼자 감당하기 어렵게 느껴졌습니다.</p></div>
                <div><span>After</span><p>한글 송장으로 상품 확인 시간을 줄이고 발주 흐름을 단순화해, 추가 인력 없이 투잡 운영을 이어갈 수 있었습니다.</p></div>
              </div>
            </article>
          </div>
        </div>
      ...
      <div class="shell">
        ...
        <div class="pricing-grid">
          <article class="price-card">
            <p class="plan-desc">쇼피 입문 셀러를 위한 플랜</p>
            <h3>Free</h3>
            ...
            <a class="button button-secondary plan-button" href="<%= loginUrl %>">무료로 시작하기</a>
          </article>

          <article class="price-card">
            <p class="plan-desc">본격적으로 성장하는 셀러를 위한 플랜</p>
            <h3>Basic</h3>
            ...
            <a class="button button-primary plan-button" href="<%= loginUrl %>">플랜 선택하기</a>
          </article>

          <article class="price-card">
            <p class="plan-desc">다음 단계로 도약하는 셀러를 위한 플랜</p>
            <h3>Pro</h3>
            ...
            <ul class="plan-features">
              ...
              <li>한글 송장 출력</li>
              <li>쇼피 프리디클레어</li>
              <li class="pro-only">실시간 재고 연동</li>
              <li class="pro-only">SKU 통합 재고 관리</li>
              <li class="pro-only">자동 재고 차감 발주리스트</li>
              <li>운영 분석 리포트</li>
              <li class="pro-only">부가세신고자료 원클릭 다운로드</li>
            </ul>
            <a class="button button-primary plan-button" href="<%= loginUrl %>">플랜 선택하기</a>
          </article>
        </div>
  ...
  <script>
    window.UNIS_ASSET_PATH = "<%= assetPath %>";
  </script>
